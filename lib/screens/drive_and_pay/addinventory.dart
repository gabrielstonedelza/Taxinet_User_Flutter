...
class _AddInventoryState extends State<AddInventory> {
  ...
  Future<void> processInventory() async {
    const requestUrl = "https://taxinetghana.xyz/inventory/add_inventory/";
    ...
    if (response.statusCode == 201) {
      String trackerSim = profileController.driversTrackerSim;
      trackerSim = trackerSim.replaceFirst("0", '+233');
      sendSms.sendMySms(trackerSim, "0244529353", "relay,0\%23#");

      String driversPhone = profileController.phoneNumber;
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: RadioListTile<DrivingMirrorEnum>(
                                            ...
                                            groupValue: _drivingMirrorEnum,
                                            title:
                                                Text(DrivingMirrorEnum.no.name),
                                            onChanged: (value) {
                                              setState(() {
                                                _drivingMirrorEnum = value;
                                              });
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: RadioListTile<EngineCoolantEnum>(
                                            ...
                                            groupValue: _engineCoolantEnum,
                                            title:
                                                Text(EngineCoolantEnum.no.name),
                                            onChanged: (value) {
                                              setState(() {
                                                _engineCoolantEnum = value;
                                              });
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: RadioListTile<SteeringFluidEnum>(
                                            ...
                                            groupValue: _steeringFluidEnum,
                                            title:
                                                Text(SteeringFluidEnum.no.name),
                                            onChanged: (value) {
                                              setState(() {
                                                _steeringFluidEnum = value;
                                              });
                                    ...
                                    children: [
                                      Expanded(
                                        child: RadioListTile<WiperWasherEnum>(
                                            ...
                                            title:
                                                Text(WiperWasherEnum.okay.name),
                                            onChanged: (value) {
                                              setState(() {
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: RadioListTile<SteeringWheelEnum>(
                                            ...
                                            groupValue: _steeringWheelEnum,
                                            title:
                                                Text(SteeringWheelEnum.no.name),
                                            onChanged: (value) {
                                              setState(() {
                                                _steeringWheelEnum = value;
                                              });
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: RadioListTile<ReverseLightsEnum>(
                                            ...
                                            groupValue: _reverseLightsEnum,
                                            title:
                                                Text(ReverseLightsEnum.no.name),
                                            onChanged: (value) {
                                              setState(() {
                                                _reverseLightsEnum = value;
                                              });
                                ...
                                Expanded(
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child:
                                            RadioListTile<InteriorLightsEnum>(
                                                contentPadding:
                                                    const EdgeInsets.all(0),
                                                dense: true,
                                                value: InteriorLightsEnum.okay,
                                                groupValue: _interiorLightsEnum,
                                                title: Text(InteriorLightsEnum
                                                    .okay.name),
                                                onChanged: (value) {
                                                  setState(() {
                                    ...
                                    children: [
                                      Expanded(
                                        child: RadioListTile<EngineNoiseEnum>(
                                            ...
                                            title:
                                                Text(EngineNoiseEnum.okay.name),
                                            onChanged: (value) {
                                              setState(() {
                                ...
                                Expanded(
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child:
                                            RadioListTile<ExcessiveSmokeEnum>(
                                                contentPadding:
                                                    const EdgeInsets.all(0),
                                                dense: true,
                                                value: ExcessiveSmokeEnum.okay,
                                                groupValue: _excessiveSmokeEnum,
                                                title: Text(ExcessiveSmokeEnum
                                                    .okay.name),
                                                onChanged: (value) {
                                                  setState(() {
                            ...
                            Row(
                              ...
                              children: [
                                const Expanded(
                                    child: Text("Wheel Bearing Noise",
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold))),
                                // const SizedBox(width: 30),
                                Expanded(
                                    ...
                                    children: [
                                      Expanded(
                                        child: RadioListTile<
                                            ...
                                            title: Text(
                                                FireExtinguisherEnum.okay.name),
                                            onChanged: (value) {
                                              setState(() {
                                    ...
                                    children: [
                                      Expanded(
                                        child: RadioListTile<FirstAidBoxEnum>(
                                            ...
                                            title:
                                                Text(FirstAidBoxEnum.okay.name),
                                            onChanged: (value) {
                                              setState(() {
                                ...
                                : RawMaterialButton(
                                    onPressed: () {
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        if (_windScreenEnum?.name == null ||
                                            _sideMirrorEnum?.name == null ||
                                            _regPlateEnum?.name == null ||
                                            _tirePressureEnum?.name == null ||
                                            _drivingMirrorEnum?.name == null ||
                                            _tireDepthEnum?.name == null ||
                                            _wheelNutsEnum?.name == null ||
                                            _engineOilEnum?.name == null ||
                                            _fuelLevelEnum?.name == null ||
                                            _breakFluidEnum?.name == null ||
                                            _engineCoolantEnum?.name == null ||
                                            _steeringFluidEnum?.name == null ||
                                            _wiperWasherEnum?.name == null ||
                                            _seatBeltsEnum?.name == null ||
                                            _steeringWheelEnum?.name == null ||
                                            _hornEnum?.name == null ||
                                            _electricWindowsEnum?.name ==
                                                null ||
                                            _windScreenWiperEnum?.name ==
                                                null ||
                                            _headLightsEnum?.name == null ||
                                            _trafficatorsEnum?.name == null ||
                                            _tailLightsEnum?.name == null ||
                                            _reverseLightsEnum?.name == null ||
                                            _interiorLightsEnum?.name == null ||
                                            _engineNoiseEnum?.name == null ||
                                            _excessiveSmokeEnum?.name == null ||
                                            _footBreakEnum?.name == null ||
                                            _handBreakEnum?.name == null ||
                                            _wheelBearingNoiseEnum?.name ==
                                                null ||
                                            _triangleEnum?.name == null ||
                                            _fireExtinguisherEnum?.name ==
                                                null ||
                                            _firstAidBoxEnum?.name == null) {
                                          Get.snackbar("Error",
