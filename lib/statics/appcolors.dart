...
const defaultYellow = Color(0xFFffdd00);
const primaryYellow = Color(0xFFffb700);
const secondaryYellow = Color(0xFFffc300);
const snackColor = Color(0xFFffdd00);
const buttonColor = Color(0xFFffd000);
